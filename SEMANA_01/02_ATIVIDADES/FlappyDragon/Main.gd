...
var status = 1 #define se o dragão está voando
var vscore = 0 #define o score do jogo 
var x = 1.5 #define a posição horizontal
var y = 1.5 #defina a posição vertical 
